...
public class MenuDosen extends JFrame {
    ...
    public MenuDosen(String username, Connection conn, String nidn) {
        ...
        // Panel Pembungkus Atas (Logo + Judul + Welcome)
        ...
        // --- 1. LOGO UPN (TAMBAHAN BARU) ---
        // Pastikan file "logo_upn.png" ada di folder utama project (sejajar dengan folder src)
        ImageIcon originalIcon = new ImageIcon("logo_upn.png");

        // Cek jika gambar berhasil diload
        if (originalIcon.getIconWidth() > 0) {
            Image img = originalIcon.getImage();
            // Resize logo ke lebar 100px (tinggi menyesuaikan/proporsional)
            ...
            lblLogo.setBorder(BorderFactory.createEmptyBorder(0, 0, 20, 0)); // Beri jarak bawah 20px
            leftTop.add(lblLogo); // Masukkan logo paling atas
        }
