...
public class MenuInputNilai extends JFrame {
    ...
    public MenuInputNilai(Connection conn, String nidn) {
        ...
        // Action listener dipisah di bawah atau bisa langsung di sini
        ...
        btnKembali.setBorder(BorderFactory.createEmptyBorder(10, 15, 10, 15));
        btnKembali.addActionListener(e -> dispose()); // Tutup menu ini

        // PANEL BAWAH
        JPanel bottomPanel = new JPanel();
        bottomPanel.setBackground(Color.WHITE);
        bottomPanel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0)); // Sedikit jarak vertikal

        bottomPanel.add(btnInputNilai);       // Tombol LAMA
        bottomPanel.add(Box.createHorizontalStrut(20)); // Jarak antar tombol
        bottomPanel.add(btnKembali);          // Tombol BARU
